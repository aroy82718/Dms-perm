...
async def start_bot():
    ...
    # Keep Pyrogram and all background tasks on this same event loop.
    # Do not use pyrogram.idle() here because it can create/use another loop
    # in some deployments and causes: Future attached to a different loop.
    try:
        ...
        if bot.is_connected:
            try:
                ...
                # Avoid a second shutdown crash during Render termination.
